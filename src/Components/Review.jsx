    ...
    <div className="h-full">
      ...
      >
        <SwiperSlide className="text-center text-xl bg-bn-navy flex justify-center items-center flex-col ">
          <h1 className='text-2xl text-bn-gold font-montserrat'>Review #1 </h1>
...
I will highly recommend yourself, great host too!"</p>
        ...
        <SwiperSlide className=" text-center text-xl bg-bn-navy flex justify-center items-center flex-col">
          <h1 className="text-2xl text-bn-gold font-montserrat">Review #2 </h1>
        ...
        <SwiperSlide className="text-center text-xl bg-bn-navy flex justify-center items-center flex-col">
          <h1 className="text-2xl w-1/3 text-bn-gold font-montserrat whitespace-nowrap">Review #3 </h1>
